module Jekyll
  class Pager
    attr_reader :page, :per_page, :posts, :total_posts, :total_pages,
      :previous_page, :previous_page_path, :next_page, :next_page_path, :dir
    ...
    def self.paginate_path(site, num_page, dir)
      ...
      return "/#{ dir }/pages/#{ num_page }"
    end

    def initialize(site, page, post_pages, total_pages, posts_per_page, dir)
      @page = page
